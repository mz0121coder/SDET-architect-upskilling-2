package com.mz.pages.vendorportal;
...
public class DashboardPage extends AbstractPage {
    ...
    @FindBy(css = "#dataTable_filter [aria-controls]")
    private WebElement searchInput;

    @FindBy(id = "dataTable_info")
    private WebElement searchResultsCountElement;

    @FindBy(css = "a#userDropdown > .img-profile.rounded-circle")
...
//        if we do not have 5th item, it would throw an 'out of bounds' exception
//        that's fine, we want the test to fail in that case
